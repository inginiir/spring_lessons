        ...
        <div class="row">
            <ul class="pagination col justify-content-center">
                ...
                <#list body as p>
                    ...
                    <#else>
                        <li class="page-item">
                            <a class="page-link" href="${url}?page=${p-1}&amp;size=${page.getSize()}" tabindex="-1"
            ...
            <ul class="pagination col justify-content-center">
                ...
                <#list [5, 10, 15, 20] as c>
                    ...
                    <#else>
                        <li class="page-item">
                            <a class="page-link" href="${url}?page=${page.getNumber()}&amp;size=${c}" tabindex="-1"
                               aria-disabled="true">${c}</a>
                        </li>
                    </#if>
                </#list>
            </ul>
