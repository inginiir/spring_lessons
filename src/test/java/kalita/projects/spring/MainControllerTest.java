package kalita.projects.spring;

import kalita.projects.spring.controllers.MessageController;
...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//div[@id='navbarSupportedContent']/div").string("inginiir"));
    }
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main").param("filter", "test1"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/span").string("hello"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#sometag"));
    }
}
